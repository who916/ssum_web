			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<ul class="navbar-nav ms-auto py-4 py-lg-0">
					...
					<li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4"
						href="#">작품읽기</a>
						<ul class="navbar-sub">
						  <li class="navbar-sub-item"><a href="/readbook/serial.do" class="nav-sub-link px-lg-3 py-3 py-lg-4">소설</a></li>
						  <li class="navbar-sub-item"><a href="/readbook/serial.do" class="nav-sub-link px-lg-3 py-3 py-lg-4">시·에세이</a></li>
						</ul>	
					</li>
					<li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4"
						href="#">창작하기</a>
