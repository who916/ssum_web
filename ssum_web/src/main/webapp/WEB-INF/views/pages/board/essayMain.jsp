...
<body>
    ...
    <script type="text/javascript" src="/bootstrap/js/board/essayMain.js"></script>
	<!-- Navigation-->
			...
			<div class="row gx-4 gx-lg-5 justify-content-center">
				<div class="col-md-10 col-lg-8 col-xl-7">
					<div class="site-heading">
						<h1 style="color:#FFFFFF; text-align:center;">시/에세이</h1>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row gx-4 gx-lg-5 justify-content-center">
			<div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <div style="display:flex; justify-content:center; margin-bottom :2rem;">
                   <div class="pagination" id="essayPaging">
                   </div>
			</div>
		</div>
	</div>
